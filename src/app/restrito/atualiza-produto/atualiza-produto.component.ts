...
[x: string]: any;
  ...
  constructor(private _produtoServiçe: ProdutoService, private _router: Router, private _activatedRoute: ActivatedRoute) {
  ...
  listarProduto();void {
    this._produtoServiçe.getProduto{ this.produtoId }.subscribe(
      (res: any) => {
...
atualizar(id: number) {
  this._produtoServiçe.atualizarProduto(id,this.produto).subscribe(
